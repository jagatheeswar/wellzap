...
function Sidebar() {
    ...
    return (
        ...
        <div className="sidebar__container">
            <img src={userData?.data?.imageUrl} alt={userData?.data.name} width="100px" height="100px"/>
            <h1>{userData?.data.name}</h1>
            <h3>Strength and Conditioning Coach</h3>
            <Link className="view-link" to={userType === "athlete" ? "/athlete" : "/coach"} > View Profile</Link>
            {userType === "coach" ? (
                <div>
                <SidebarComponent logo="dumbell" name="Workouts" />
                <SidebarComponent logo="hamburger" name="Nutrition" />
                ...
                <div>
                <SidebarComponent logo="dumbell" name="Workout" />
                <SidebarComponent logo="hamburger" name="Nutrition" />
