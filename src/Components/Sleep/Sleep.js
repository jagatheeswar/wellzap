...
import {Edit, EmojiEmotionsOutlined, DoneRounded, SentimentVeryDissatisfiedOutlined, SentimentDissatisfied} from '@material-ui/icons'
      ...
      .then(doc=> {
        if (doc.data().metrics) {
          ...
          if( doc.data().metrics[requestDate]?.soreness){
            ...
            console.log("sleep : ",doc.data().metrics[requestDate].soreness)
      ...
      <div className="soreness">
        ...
        <div className="emoji__container">
          ...
          <IconButton
            ...
            style={{padding: 0, backgroundColor: soreness === "very-sore" ? "#ED200D" : "initial"}}
          >
          ...
          <IconButton
            ...
            style={{padding: 0, backgroundColor: soreness === "moderately-sore" ? "#ffde03" : "initial"}}
          >
          ...
          <IconButton 
            ...
            style={{padding: 0, backgroundColor: soreness === "not-sore" ? "#09af00" : 'initial'}}
          >
