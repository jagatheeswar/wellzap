...
function AthleteMedicalAssessment_coach({ route, navigation }) {
  ...
  window.history.pushState(null, "", "/Athlete/medical-assessment");
...
export default AthleteMedicalAssessment_coach;
