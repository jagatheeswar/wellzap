...
function AthleteMeasurements_coach({ route, navigation }) {
  ...
  console.log(params);
  window.history.pushState(null, "", "/Athlete/anthropometric-measurements");
...
export default AthleteMeasurements_coach;
